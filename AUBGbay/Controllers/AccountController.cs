...
namespace AUBGbay.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public static DateTime OBirthday { get; set; }
        public static string OFname { get; set; }
        public static string OLname { get; set; }
        public static string OAddress { get; set; }
                ...
                switch (result)
                {
                    ...
                    default:
                        ...
                        if (loginInfo.Login.LoginProvider == "Facebook")
                        {
                            ...
                            dynamic uAddress = fb.Get("me?fields=location");
                            //dynamic Addressinfo = JsonConvert.DeserializeObject(uAddress);

                            loginInfo.Email = uEmail.email;
                            OBirthday = DateTime.ParseExact(uBirthDate.birthday, "MM/dd/yyyy", CultureInfo.InvariantCulture); 
                            OFname = uFName.first_name;
                            OLname = uLName.last_name;
                            OAddress = uAddress.name;
                            //var jsonAddress = JsonConvert.DeserializeObject<List<string>>(uAddress.location);
                           // OAddress = jsonAddress.First();
                    }
                        else
                        {
                            OEmail = null;
                        ...
                        return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { ExtUsername= loginInfo.DefaultUserName , Email = loginInfo.Email, ExtFirstName =OFname, ExtLastName = OLname, BirthDate = OBirthday, Address = OAddress }); //default microsoft template
